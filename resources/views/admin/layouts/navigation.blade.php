    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex" :active="request()->routeIs('viewbook')">
                    <x-nav-link :href="route('view.book')">
                        {{ __('Search Books') }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex" :active="request()->routeIs('storebook')">
                    <x-nav-link :href="route('store.book')">
                        {{ __('Issue Books') }}
                    </x-nav-link>
                </div>
